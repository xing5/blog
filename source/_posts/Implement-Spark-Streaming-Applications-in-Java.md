...
public class ExampleApp  {
    ...
    @Parameter(names = "-host", variableArity = true, description = "Hostname of the slave machine to which the flume data will be sent", required = false)
    String host = "localhost"; //Run Spark locally with as many worker threads as logical cores on your machine.

    @Parameter(names = "-port", variableArity = true, description = "Port of the slave machine to which the flume data will be sent", required = false)
    int port = 4445; 
    ...
    public static void main(String[] args) {
        ...
        JavaPairDStream<Tuple2<String, String>, Tuple4<Integer, Integer, Integer, Integer>> sampleStream = flumeStream
                .flatMapToPair(new ExampleAppFunctions.ExtractPairFromEvents())
...
public class ExampleAppFunctions {
    ...
    public static class ExtractPairFromEvents implements PairFlatMapFunction<SparkFlumeEvent, Tuple2<String, String>, Tuple4<Integer,Integer,Integer,Integer>> {
        ...
        @Override
        public Iterable<Tuple2<Tuple2<String, String>, Tuple4<Integer, Integer, Integer, Integer>>> call(SparkFlumeEvent event)
                throws Exception {
            List<Tuple2<Tuple2<String, String>, Tuple4<Integer, Integer, Integer, Integer>>> rstList = Lists.newArrayList();
            ...
            try {
                ...
                if (cols.length > 514) {
                    logger.trace("MSG: {}|{}|{}|{}|{}|{}",cols[0], cols[507], cols[511], cols[509], cols[518], cols[514]);
                    ...
                    Tuple4<Integer, Integer, Integer, Integer> val = 
                            new Tuple4<Integer, Integer, Integer, Integer>(ExampleAbnormalEnbActQci[1] + ExampleAbnormalMmeActQci[1],
                    ...
                    rstList.add(new Tuple2<Tuple2<String, String>, Tuple4<Integer, Integer, Integer, Integer>>( key, val));
                }
            } catch(Exception e) {
                logger.error(e.getMessage());
            }
    ...
    public static class ReduceCellByNode implements Function2<Tuple4<Integer, Integer, Integer, Integer>, Tuple4<Integer, Integer, Integer, Integer>,
    ...
    public static class OutputNode implements Function<JavaPairRDD<Tuple2<String,String>, Tuple4<Integer, Integer, Integer, Integer>>, Void> {
...
```
$ cd $SPARK_DIR
$ nohup ./bin/spark-submit --class example.package.name.ExampleApp --master spark://SPARK_HOST:7077 --executor-memory 256M "/full/path/to/the/jar/of/your/app" -host localhost -port 4444 > exampleapp.log 2>&1 < /dev/null &
```
